...
subtest 'Helper' => sub {
    ...
    is(
        scalar @missing_options,
        0,
        'All expected command options are present'
    );
    if (@missing_options) {
        diag "Missing options: " . join(", ", @missing_options);
    }
