package Sentra::Component::Maintained {
    ...
    sub new {
        ...
        foreach my $repository (@repositories) {
            my $commits_response = $user_agent -> get(
